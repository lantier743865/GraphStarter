...
import com.top.wuxiaolong.launcher.executor.Executors;
import com.top.wuxiaolong.launcher.executor.TaskExecutor;
import com.top.wuxiaolong.launcher.listener.IdleHandler;
import com.top.wuxiaolong.launcher.task.ILaunchTask;
import com.top.wuxiaolong.launcher.task.TaskSortUtil;
...
public class AppLauncher implements IAppLauncher {
    ...
    private void executeTasks(ILaunchTask task) {
        if (task == null) {
            Log.e(TAG, "---->>executeTasks:task is null ");
            return;
        }
